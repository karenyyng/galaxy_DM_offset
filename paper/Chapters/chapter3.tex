...
distribution. In these dense regions of the clusters, the rates of particle
interactions may be enhanced, including the long-suspected self-interaction of DM
particles (hereafter, SIDM).  
There have been two fronts for inferring the self-interaction cross-section of 
dark matter, i.e. $\sigma_{\rm SIDM}$.

We propose a third aspect in this noise dominated 





Many papers have used the offsets between the `center' of the DM 
distribution and those of the member galaxies to give constraints on 
the self-interaction cross section of DM, i.e. $\sigma_{\rm SIDM}$.
In particular, a large portion of these studies 
have made use of merging galaxy clusters.
By assuming the galaxies being collisionless in simulated merging clusters,
\cite{Randall2008d} used the offset of the DM population 
from the member galaxies can provide estimates of $\sigma_{\rm SIDM}$. 



The first constraints was derived using the offsets of 25 kpc between the DM and the member
the analysis of the Bullet cluster (\citealt{Markevitch2004} and \citealt{Bradac2006b}). 
Many other studies of merging galaxy clusters followed, 
including \cite{Dawson2013} reporting offsets of 129 kpc and 47 kpc for the southern
and the northern subcluster of the Musketball cluster;
...
% such as \cite{George2012a} also report galaxy-DM offsets of the same order of magnitude,
% at around $50 - 150$ kpc. 

Simulators have also joined hands to study the dependence 
of the observables of SIDM on cluster configurations. 

incorporate suitable implementations of the DM self-interaction


In `staged' simulations where 
merging galaxy clusters 
in what we call . 



The initialization (or staging) of the 
mergers are often made more ideal to maximize the
observables of SIDM than realistic observational conditions.  
 
The initial conditions include 
the spatial and velocity distributions of the different components 
of the clusters. Often times, galaxies were initialized under a parametric  
spatial distribution   
(\citealt{Randall2008d}, \citealt{Kahlhoefer14}, \citealt{Robertson2016}), 
such as an Navarro-Frenk-White (NFW) profile. 
Details such as galaxy morphology, or dynamical friction are sometimes ignored. 
...
\begin{figure*}
	...
	\caption{Left: A box plot showing the distribution of the total normalized
	  ...
	  Right: A box plot showing the distribution of $\Delta y_{\rm KDE}$ for each cluster 
		...
		\label{fig:projected_KDE_offset_distribution}. The median of $\nu$ show on the
...
number) and under the auspices of the U.S. DOE by LLNL under Contract DE-AC52-07NA27344; 
