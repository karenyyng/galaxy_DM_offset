...
We list the optimistic assumptions from similar staged merger simulations as follows: 
...
method for giving quantitative estimates for the impact parameters for mergers to ensure
a zero impact parameter assumption is satisfied. 
...
population have zero offsets for any $\sigmaSIDM$ value. 
