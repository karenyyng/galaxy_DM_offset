...
These assumptions may lead to problems when we assume all the observed offset
...
\citep{Beers90}. We compute the robust statistics using the 
implementation \texttt{astropy.stats.biweight\_location}
...
Our results showing the offset distributions are highly relevant to two other types of
observational studies: 
The first type tries to make the spatial maps or 
estimate the mass of the DM distribution of galaxy clusters 
...
merger configurations (Kim et al. 2016): 
...
be present for below 5 Gyrs, and during most of 5 Gyrs, 
...
before the clusters would give statistically significant offset signal when compared 
...
many clusters for such a comparison study. 
The computational cost of finding
enough clusters that can give statistically significant
$\offset_{\SIDM}$ can be expensive.
% To add to the confusion, there is also a fluctuating offset 
% for CDM models with a moderate impact parameter as shown in Fig. 13 of Kim et al. 
...
\citep{Perez2007}.\ifthenelse{\boolean{thesis}}{}{Part of this work was performed under the Hubble Space Telescope grant
