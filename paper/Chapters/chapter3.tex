...
for optical survey data those galaxy magnitudes, but not spatial mass distribution 
...
\begin{figure*}
	...
	accurate when
	there is more than one significant component.  
...
\begin{figure*}
	...
	\caption{Left: A box plot showing the distribution of the total normalized peak density 
		for each cluster. 
...
Each of the two unrelaxedness criteria have significant a positive correlation of $\sim 0.70$
...
\subsection{How to best visualize cluster galaxy data?}
...
to the corresponding population of clusters in a CDM simulation. It is unclear
that the Illustris simulation has enough volume to contain clusters with 
