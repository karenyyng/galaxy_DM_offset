...
the projected visualization, we confirm that
...
\begin{figure*}
	...
	\caption{The distribution of projected offsets for each of the clusters 
		based on 768 projections. The offsets were computed between the closest DM 
		peak to the brightest luminosity peak of each cluster. [TODO] elaborate on
		what the different symbols in the boxplot mean.
...
At this uncertainty level, it is hard to disentangle the effects 
from the intrinsic statistical offset with the physical signal from SIDM. 
