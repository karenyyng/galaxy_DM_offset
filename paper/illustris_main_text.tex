...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{Fig1_color_magnitude_diagram.png}
	\caption{Color-magnitude diagram of one of the galaxy clusters that is selected for 
		...
		the cosmological redshift (distance) is $z = 0.4$. 
...
\begin{figure*}
	\includegraphics[width=.95\linewidth]{ph_fig_galaxycenter_mixtureTests.pdf}
...
known mean and variance. (See \ref{})\\
...
kpc assuming a cosmological redshift of [TODO] $z = 0.4$.
