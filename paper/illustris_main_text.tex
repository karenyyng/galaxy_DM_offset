...
We make use of the {\sc{SUBFIND}} member particle for the DM and the 
{\sc{FoF}} subhalo identification as our
...
analyzing the data. 
There are a long list of subject that are up for debate, 
...
and $\Delta y$ or just the direction along the approixmate merger axis.
...
\begin{itemize}
		...
		offsets, $|\Delta s_{\rm KDE}|'$ is $\sim 30$ kpc from the Illustris sample. 
			...
			The following may also be possible: zero magnitude of
			...
			constrain $\sigma_{\rm SIDM}$ has to account for the statistical and 
			observational uncertainties 
			or else the estimate of $\sigma_{\rm SIDM}$ will be biased. 
			A population of galaxy clusters is needed to use galaxy-DM offset 
			to constrain $\sigma_{\rm SIDM}$. 
			\\
