...
(2016), using 5800 galaxy tracer particles, and \cite{Kahlhoefer14} also show 
null galaxy-DM offset during most periods of their control staged simulation with $\sigma_{\rm
...
The different representation of offsets will have different statistical power
...
% \hline 
% Cluster & Observed $\Delta s$ & method & subcluster & subcluster mass & mass
% ratio & citation 
% \hline
% \hline
% \end{tabular} 
...
\subsection{Total significant peak density}
