...
resolution is high enough for the smoothed histograms to be accurate.  
...
\begin{table*}
	% \begin{minipage}{180mm} 
	 ...
	 mass ($10^{14}$ M$_\odot$) & merger evidence &  reference\\
	 \hline
	 Bullet  & 25$~\pm~29$ & number or luminosity & strong \& weak lensing & $\gtrsim 0.32$ &
	 northwest &2.6 & shock in X-ray & \citealt{Randall2008d}\\
	 % Bullet & & & & & southeast & 2.5 & & \citealt{Bradac2008} \\
	 Baby Bullet &&&&&& \\
	 Musketball & 129 & number density & weak lensing & $>0.05$ & southern & 3.1 & DM-gas
	 dissociation  & \citealt{Dawson2013}\\
	 Musketball & 47 & number density & weak lensing & $>0.32$ &northern & 1.7 &  & \citealt{Dawson2013} \\
	 Abell 3827 & 6 & BCG & strong lensing & $> 0.05$ & central & & & \citealt{Williams2011a}\\ 
	 Abell 520 & & & & & & &  & \citealt{Clowe2012} \\
	 Abell 1689 & & & & & & &  & \citealt{Mohammed2014} \\
	 El Gordo & 570 & number density & weak lensing & $>0.01$ & southeast & 11 &
	 radio relic &\citealt{Jee2014} \\
	 Sausage & $\sim190 \pm 150$ & number density & weak lensing & $\gtrsim 0.05^\dagger$ & both
	 & 11. \& 9.8 & radio relic &\citealt{Jee2015}\\ 
...
With the relatively relaxed samples, the inferred offsets from different
methods still show discrepancies. 
...
% The number of unrelaxed clusters far outnumber the ones that are dynamically 
% relaxed. 
