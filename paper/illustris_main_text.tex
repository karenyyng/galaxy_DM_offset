...
% Most strongly lensed galaxy clusters found the corresponding BCG close to one of the DM 
% peaks (\citealt{Oguri2009}, ). 
...
% This number is in section 3.1 of Zitrin2012 
...
The analysis of 25 galaxy clusters of the LoCuSS survey by \cite{Oguri2010} fitting elliptical NFW
...
\subsubsection{Comparison to CDM cosmological simulations}
...
also identified the maximum SPH density peak with various summary location of
...
spanning up to several hundred $h^{-1}$ kpc due to disturbed clusters. Our 
tight 68-th percentile of 
$\Delta y_{\rm BCG } \pm 3$ kpc gives some confidence that 
...
inference methods. Those causes are, however, not exhaustive. 
\cite{Dietrich2012} ray-traced through the substructures through the N-body 
Millennium Simulation and showed that a combination of shape noise and 
...
15 arcsec in the presence of shape noise. While this source of uncertainty is
relatively unimportant in this analysis due to the very high resolution of the
DM particles, it explains why the observed offsets may not be created by 
physical forces and why the uncertainties need to be properly accounted for.

% Although \cite{Cui2015} also made histograms for the offsets between the BCG
% and the (gravitational) potential centers of various particle types, we 
% cannot read off the distances between the (gravitational) 
% potential centers of the DM and the galaxy particles because   of each 
% cluster.  
