...
10 evenly spaced values of $\phi$ where $0 \leq \phi \leq \pi$, 

This method gives us samples of the joint distribution: 
\begin{equation}
	P(\Delta \eta, \phi, \xi, h_{mer}, \psi_g, \psi_D, I_g, I_D). 
\end{equation}


Binning the samples based on $\Delta \eta$ and $h_{mer}$ gives us the
