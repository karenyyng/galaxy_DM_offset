...
def get_gpBy_star_objects(
        star_df, no_of_gal_keys=6):
    """
...
def get_gpBy_DM_objects(
        DM_df,  no_of_DM_keys=9):
    """
    This helps massage the df objects to a similar form as a dictionary form
    """
...
def DM_h5path_to_star_groupbykey(DM_clstPath):
    """
    :DM_clstPath: TODO
    :returns: tuple of strings, star_gpBy_key
    """
    return tuple(convert_DM_path_to_star_path(DM_clstPath).split("/"))
